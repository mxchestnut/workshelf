...
export default function FreeBooks() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-600 to-emerald-600 pb-8">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="mb-6">
            ...
            <p className="text-green-100">70,000+ public domain books from Project Gutenberg</p>
          </div>
          ...
          <div className="relative max-w-2xl">
            <input
              ...
              className="w-full px-4 py-3 pl-12 pr-24 rounded-lg border-2 border-green-300 focus:border-white focus:ring-2 focus:ring-white transition-all"
            />
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
            <button
              onClick={searchBooks}
              disabled={searching || !searchQuery.trim()}
              className="absolute right-2 top-1/2 -translate-y-1/2 px-4 py-1.5 bg-green-600 text-white rounded-md hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
              {books.map((book) => (
                ...
                >
                  {/* Book Cover */}
                  <div className="aspect-[2/3] bg-gradient-to-br from-green-100 to-emerald-100 relative">
                    {book.cover_url ? (
                      <img
                        src={book.cover_url}
                        alt={book.title}
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between text-xs text-gray-500">
                      ...
                      {book.epub_url && (
                        <span className="text-green-600 font-medium">EPUB</span>
                      )}
                    </div>
                  </div>
                </div>
