        ...
        <div className="prose prose-blue max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              By accessing and using Workshelf ("the Platform"), you accept and agree to be bound by the terms and 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Workshelf is a collaborative platform for creative writing, storytelling, and community building. 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              By posting User Content, you grant Workshelf a non-exclusive, worldwide, royalty-free license to:
            </p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              The Platform and its original content, features, and functionality are owned by Workshelf and are 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, WORK SHELF SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, 
